// https://raw.githubusercontent.com/fpinscala/fpinscala/master/exercises/src/main/scala/fpinscala/streamingio/StreamingIO.scala
...
object ImperativeAndLazyIO {
  ...
  object Examples {
    def lines: Stream[String] = sys.error("defined elsewhere")
